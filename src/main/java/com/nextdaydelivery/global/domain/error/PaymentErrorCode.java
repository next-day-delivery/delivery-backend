...
public enum PaymentErrorCode implements ErrorCode {
    ...
    PAYMENT_PAID_ALREADY(HttpStatus.CONFLICT, "P003", "결제 처리가 이미 완료 되었습니다."),
    PAYMENT_ALREADY_PROCESSED(HttpStatus.CONFLICT, "P004", "결제 처리가 이미 진행되고 있습니다."),
    PAYMENT_CONCURRENCY_ERROR(HttpStatus.CONFLICT, "P005", "결제 처리가 동시에 요청되어 진행할 수 없습니다."),
